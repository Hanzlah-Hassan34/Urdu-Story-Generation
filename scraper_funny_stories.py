...
def get_category_url(page_num):
    if page_num == 1:
        return "https://www.urdupoint.com/kids/category/funny-stories.html"
    return f"https://www.urdupoint.com/kids/category/funny-stories-page{page_num}.html"
